      ...
      <div className="px-[20px]">
        ...
        <div className="flex w-full px-4 justify-center items-center">
          <p className="text-center pt-3 text-xs sm:text-sm md:text-base lg:w-1/2 font-medium text-[#36485C] pb-4 font-sans break-words whitespace-normal">
            HatchEvent empowers event organizers to create unforgettable
            experiences with AI and cutting-edge technology. It simplifies
            event-related services, ensuring a seamless planning process for
            both private and corporate event planners.
          </p>
        </div>
